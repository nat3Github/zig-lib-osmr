...
pub fn set_background(self: *This, xpixel: Color) void {
    const pixel = col_black_and_white(xpixel);
...
fn col_black_and_white(xcol: Color) Color {
    const xbw = to_bw(xcol.rgb(), 1);
    var col = xcol;
    col.rgba_arr[0] = xbw;
    col.rgba_arr[1] = xbw;
    col.rgba_arr[2] = xbw;
...
inline fn draw(self: *This, layer: *const Layer, feat: *const Feature, xcol: Color, line_width: f64, dotted: bool) void {
    const col = col_black_and_white(xcol);
